...
data class UserData(
    ...
    data class Result(
        ...
        val userPrivacySettingEmail: Int? = 0,
        ...
        val userProfileContactNotificationTag: Int? = 0,
        ...
        val userProfilePrivacyTag: Int? = 0,
        ...
        val userProfileSecurityTag: Int? = 0,
        ...
        val userProfileShortLink: String? = "",
