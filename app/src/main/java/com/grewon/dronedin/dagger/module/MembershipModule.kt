...
import com.grewon.dronedin.membership.presenter.MembershipListPresenter
...
class MembershipModule {
    ...
    @Singleton
    @Provides
    fun provideMembershipListPresenter(): MembershipListContract.Presenter {
        return MembershipListPresenter()
    }

    @Singleton
    @Provides
    fun provideMembershipPurchasePresenter(): MembershipPurchaseContract.Presenter {
        return MembershipPurchasePresenter()
    }
