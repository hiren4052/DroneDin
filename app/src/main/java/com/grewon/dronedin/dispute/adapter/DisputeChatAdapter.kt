...
class DisputeChatAdapter(
    ...
    interface OnItemClickListeners {
        ...
        fun onImageItemClick(jobsDataBean: DisputeChatDataBean.Data?)

        fun onImageDownloadClick(jobsDataBean: DisputeChatDataBean.Data?)
    ...
    fun addMessageItem(chatBean: DisputeChatDataBean.Data) {
        itemList.add(0, chatBean)
        notifyItemInserted(0)
    }


    fun addMessageItemsList(list: ArrayList<DisputeChatDataBean.Data>) {
        itemList.addAll(list)
        notifyDataSetChanged()
    }

    fun addOldMessageItemsList(list: ArrayList<DisputeChatDataBean.Data>) {
        itemList.addAll(itemList.size, list)
        notifyItemRangeChanged(itemList.size - list.size, itemList.size)
    }


    fun addOffsetMessageItemsList(list: ArrayList<DisputeChatDataBean.Data>) {
