...
public class AppConstant {
    companion object {
        ...
        const val HISTORY_JOB_STATUS: String = "history"
        const val MILESTONE_COMPLETED_STATUS: String = "completed"
        const val MILESTONE_ACTIVE_STATUS: String = "active"
        const val MILESTONE_PENDING_STATUS: String = "pending"
        const val MILESTONE_CANCELLED_STATUS: String = "cancelled"
